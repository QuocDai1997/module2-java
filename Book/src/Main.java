public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Book have category " + "'" + fiction + "'" + "is " + countCategory);
        ...
        System.out.println("Book in FictionBook have price less than 150.000 is " + countPriceBook);
    }



//    public int countPrice(Book[] list, int price, FictionBook fictionBook){
//        int countPrice = 0;
//        for (int i =0; i < list.length; i++){
//            if(list[i] instanceof FictionBook){
